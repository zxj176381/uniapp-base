...
/***/ (function (module, exports, __webpack_require__) {
        ...
        Component({
          ...
          methods: {
            connectContext: function connectContext(ctx) {
              this.ctx = ctx;
            },
            disconnectContext: function disconnectContext() {
              if (this.ctx) {
                this.ctx = undefined;
              }
            },
            ...
            setIsQuizzing: function setIsQuizzing(isQuizzing) {
              this.setData({ isQuizzing: isQuizzing });
            }
          },
          lifetimes: {

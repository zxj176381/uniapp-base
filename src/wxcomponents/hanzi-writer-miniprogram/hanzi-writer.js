...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["HanziWriter"] = factory();
  else root["HanziWriter"] = factory();
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
          ...
          var _assign = function _assign(target) {
            ...
            for (
              var _len = arguments.length, overrides = Array(_len > 1 ? _len - 1 : 0), _key = 1;
              _key < _len;
              _key++
            ) {
          ...
          function copyAndMergeDeep(base, override) {
            ...
            for (var key in override) {
              ...
              if (
                baseVal &&
                overrideVal &&
                (typeof baseVal === "undefined" ? "undefined" : _typeof(baseVal)) === "object" &&
                (typeof overrideVal === "undefined" ? "undefined" : _typeof(overrideVal)) === "object" &&
      ...
      /***/ function (module, exports, __webpack_require__) {
          ...
          var recursiveCalc = function recursiveCalc(i, j) {
            ...
            if (i === 0 && j === 0) {
              ...
              results[i][j] = Math.max(
                Math.min(recursiveCalc(i - 1, j), recursiveCalc(i - 1, j - 1), recursiveCalc(i, j - 1)),
        ...
        var normalizeCurve = function normalizeCurve(curve) {
          ...
          var meanX = average(
            outlinedCurve.map(function (point) {
              return point.x;
            })
          );
          var meanY = average(
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var hideCharacter = function hideCharacter(charName, character, duration) {
          return [new Mutation("character." + charName + ".opacity", 0, { duration: duration, force: true })].concat(
        ...
        var highlightStroke = function highlightStroke(stroke, color, speed) {
          ...
          return [
            ...
            new Mutation("character.highlight.strokes." + strokeNum + ".opacity", 0, { duration: duration })
          ];
        };
      ...
      /***/ function (module, exports, __webpack_require__) {
            ...
            return _this._renderState
              .run(
                characterActions.showCharacter(
                  "main",
                  _this._character,
                  typeof options.duration === "number" ? options.duration : _this._options.strokeFadeDuration
                )
              )
              .then(function (res) {
            ...
            return _this2._renderState
              .run(
                characterActions.hideCharacter(
                  "main",
                  _this2._character,
                  typeof options.duration === "number" ? options.duration : _this2._options.strokeFadeDuration
                )
              )
              .then(function (res) {
                return callIfExists(options.onComplete, res);
            ...
            return _this5._renderState
              .run(
                characterActions.highlightStroke(
                  _this5._character.strokes[strokeNum],
                  _this5._options.highlightColor,
                  _this5._options.strokeHighlightSpeed
                )
              )
              .then(function (res) {
                return callIfExists(options.onComplete, res);
        ...
        HanziWriter.prototype.loopCharacterAnimation = function () {
          ...
          this.cancelQuiz();
          return this._withData(function () {
            return _this6._renderState.run(
              characterActions.animateCharacterLoop(
                "main",
                _this6._character,
                _this6._options.strokeFadeDuration,
                _this6._options.strokeAnimationSpeed,
                _this6._options.delayBetweenStrokes,
                _this6._options.delayBetweenLoops
              ),
              { loop: true }
            );
          });
        ...
        HanziWriter.prototype.showOutline = function () {
          ...
          return this._withData(function () {
            return _this9._renderState
              .run(
                characterActions.showCharacter(
                  "outline",
                  _this9._character,
                  typeof options.duration === "number" ? options.duration : _this9._options.strokeFadeDuration
                )
              )
              .then(function (res) {
                return callIfExists(options.onComplete, res);
        ...
        HanziWriter.prototype.hideOutline = function () {
          ...
          return this._withData(function () {
            return _this10._renderState
              .run(
                characterActions.hideCharacter(
                  "outline",
                  _this10._character,
                  typeof options.duration === "number" ? options.duration : _this10._options.strokeFadeDuration
                )
              )
              .then(function (res) {
                return callIfExists(options.onComplete, res);
        ...
        HanziWriter.prototype.updateColor = function (colorName, colorVal) {
          ...
          return this._withData(function () {
            var duration =
              typeof options.duration === "number" ? options.duration : _this11._options.strokeFadeDuration;
        ...
        HanziWriter.prototype.setCharacter = function (char) {
          ...
          this._withDataPromise = this._loadingManager.loadCharData(char).then(function (pathStrings) {
            ...
            var hanziWriterRenderer = new _this13._renderer.HanziWriterRenderer(
              _this13._character,
              _this13._positioner
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function RenderState(character, options, onStateChange) {
          ...
          this.state = {
            options: {
              customStrokeOrder: options.customStrokeOrder,
              customStrokeOrderColor: colorStringToVals(options.customStrokeOrderColor),
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Quiz.prototype.endUserStroke = function () {
          ...
          if (isMatch) {
            ...
            this._handleFailure();
            if (
              this._numRecentMistakes >= this._options.showHintAfterMisses &&
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var strokeMatches = function strokeMatches(userStroke, character, strokeNum) {
          ...
          if (closestMatchDist < strokeMatchData.avgDist) {
            ...
            var leniencyAdjustment =
              (0.6 * (closestMatchDist + strokeMatchData.avgDist)) / (2 * strokeMatchData.avgDist);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var startQuiz = function startQuiz(character, fadeDuration) {
          return characterActions.hideCharacter("main", character, fadeDuration).concat([
            new Mutation(
              "character.highlight",
              {
                opacity: 1,
        ...
        var removeUserStroke = function removeUserStroke(userStrokeId, duration) {
          return [
            new Mutation("userStrokes." + userStrokeId + ".opacity", 0, { duration: duration }),
        ...
        var highlightCompleteChar = function highlightCompleteChar(character, color, duration) {
          return [new Mutation("character.highlight.strokeColor", color)]
        ...
        HanziWriterRenderer.prototype.mount = function (target) {
          ...
          svg.attr(
            ...
            "\n    translate(" +
              ...
              ")\n    scale(" +
              this._positioner.scale +
              ", " +
              -1 * this._positioner.scale +
              ")\n  "
          );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function HanziWriterRenderer(character, positioner) {
          ...
          this._outlineCharRenderer = new CharacterRenderer(character);
          this._highlightCharRenderer = new CharacterRenderer(character);
          this._strokeOrderRenderder = new CharacterRenderer(character);
        }
        ...
        HanziWriterRenderer.prototype.render = function (props) {
          ...
          this._animationFrame(function (ctx) {
            ...
            if (props.options.customStrokeOrder) {
              _this._strokeOrderRenderder.render(
                ctx,
                {
                  opacity: props.character.outline.opacity,
                  strokes: props.character.outline.strokes,
                  strokeColor: props.options.customStrokeOrderColor
                },
                props.options.customStrokeOrder
              );
            }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        CharacterRenderer.prototype.render = function (ctx, props, strokeOrder) {
          if (props.opacity < 0.05) return;
          for (var i = 0; i < (strokeOrder ? strokeOrder : this._strokeRenderers.length); i++) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
          ...
          var getCharDataUrl = function getCharDataUrl(char) {
            return "https://ldwh.oss-cn-hangzhou.aliyuncs.com/ldwh_admin/hanziwriter/" + char + ".json";
          };
